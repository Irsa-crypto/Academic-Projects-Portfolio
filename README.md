...
By configuring real network equipment for the first time, I gained a clear understanding of how infrastructures are built and managed.

I also created my first websites using: HTML, CSS, JavaScript, PHP. I worked with **CSV files** to read, process and analyze data for the first time, which helped me understand how to handle structured information.
...
Despite this, I managed to: **lead a cybersecurity club** during the second half of the year, participate in **theatre** every Thursday evening, work a **student job** on weekends. All of this confirmed my desire to continue in the IT field.
